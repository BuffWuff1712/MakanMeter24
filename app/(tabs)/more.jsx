      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            >
              <Text style={styles.modalButtonText}>Change Height, Weight, Gender</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text style={styles.modalButtonText}>Placeholder Button 1</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text style={styles.modalButtonText}>Placeholder Button 2</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.closeButton}
