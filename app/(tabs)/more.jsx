...
//new addition here 
import { signOut, changePassword, getUserDetails, updateUser, updateProfilePic, searchUsernames } from '../../lib/supabase';
            ...
            >
              <View style={styles.modalContainer}>
                <View style={styles.modalContentSmall}>
                  <UserSearch searchFunction={searchUsernames} />
                  <TouchableOpacity
...
import { Picker } from 'react-native-wheel-pick';
import { icons } from '../../constants';
import { signOut, changePassword, getUserDetails, updateUser, updateProfilePic, searchUsernames, getUserDetailsByUsername } from '../../lib/supabase';
import { useGlobalContext } from '../../context/GlobalProvider';
import { router } from 'expo-router';
import borderRadiusesInstance from 'react-native-ui-lib/src/style/borderRadiuses';
import UserSearch from '../../components/UserSearch.jsx';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabsContainer}>
        ...
        <View style={styles.tabRow}> 
          ...
          {showSearchBar && (
            <Modal visible={showSearchBar} animationType="slide" transparent={true}>
              <View style={styles.modalContainer}>
                <View style={styles.modalContentSmall}>
                  <UserSearch searchFunction={searchUsernames} onUserClick={handleUserClick}/>
                  <TouchableOpacity style={styles.closeButton} onPress={() => setShowSearchBar(false)}>
                    <Text style={styles.tabText}>Close</Text>
                  </TouchableOpacity>
                </View>
              </View>
