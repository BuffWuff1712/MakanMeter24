const calculateNegativePoints = (calories, sugars, saturated_fat, sodium) => {
    let points = 0;
...
const calculatePositivePoints = (protein, dietary_fiber, vitamins_minerals) => {
    let points = 0;
...
const calculateVitaminsMineralsScore = (calcium, iron, magnesium, vitamin_a, vitamin_b12, vitamin_c, vitamin_d, zinc) => {
