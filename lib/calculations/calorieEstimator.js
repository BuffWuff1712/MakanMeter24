...
export function calculateCalorieNeeds(data) {
    ...
    // Calculate calorie intake ranges
    let calorieRangeLower = Math.round(tdee * 0.8); // For weight loss (20% deficit)
    let calorieRangeUpper = Math.round(tdee * 1.2); // For weight gain (20% surplus)
